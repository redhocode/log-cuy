...
const DataSpkPage: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    const fileName = `Data_SPK_${searchTerm ? searchTerm : ''}_${new Date().toISOString().split('T')[0]}${EXCEL_EXTENSION}`;
  ...
  // Anda bisa menambahkan statistik lain jika ada data status SPK
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Semua SPK</p>
          </CardContent>
        </Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <Input
                  type="search"
                  placeholder="Cari berdasarkan nomor SPK, pelanggan, atau produk..."
                  value={searchTerm}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-between items-start sm:items-center">
            <div className="text-sm text-muted-foreground">
              {searchTerm 
                ? `Menampilkan ${filteredItems} dari ${totalItems} data SPK (setelah pencarian)`
